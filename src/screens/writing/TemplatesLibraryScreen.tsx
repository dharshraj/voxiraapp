    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          <ScrollView style={Platform.OS === 'web' ? ({ height: '100%', overflowY: 'auto' } as any) : undefined} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 20 }}>
