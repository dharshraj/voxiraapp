...
const s = StyleSheet.create({
  ...
  metricsCard:   { backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: 14, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', marginHorizontal: 20, marginBottom: 16 },
  metricRow:     { flexDirection: 'row', alignItems: 'center', gap: 10, padding: 12, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.06)' },
  metricIcon:    { width: 32, height: 32, borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
  metricLabel:   { fontSize: 13, fontWeight: '600', color: '#F1F5F9', marginBottom: 1 },
  metricDesc:    { fontSize: 11, color: 'rgba(241,245,249,0.40)' },
  practiceCard:  { backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: 14, padding: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', marginHorizontal: 20, marginBottom: 16, gap: 12 },
  practiceRow:   { flexDirection: 'row', alignItems: 'flex-start', gap: 12 },
  practiceEmoji: { fontSize: 20, marginTop: 2 },
  practiceTitle: { fontSize: 13, fontWeight: '600', color: '#F1F5F9', marginBottom: 2 },
  practiceTip:   { fontSize: 12, color: 'rgba(241,245,249,0.50)', lineHeight: 17 },
});
